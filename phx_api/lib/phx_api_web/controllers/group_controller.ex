...
#  # TODO: REVENIR SUR CETTE FOCNTION
#  def create(conn, %{"group" => group_params}) do
#    # Récupérez les ids des managers à partir des paramètres du groupe
#    manager_ids = Map.get(group_params, "manager_ids")
#    IO.inspect(manager_ids)
#
#    # Assurez-vous que le manager_id est un entier valide
#    with user = TimeManager.Accounts.get_user!(manager_ids) do
#      case user do
#        %TimeManager.Accounts.User{role: ["MANAGER"]} ->
...
#        conn
#        |> put_status(:forbidden)
#        |> json(%{message: "Accès refusé pour les utilisateurs sans le rôle 'SUPER_MANAGER'."})
#    end
#  end
